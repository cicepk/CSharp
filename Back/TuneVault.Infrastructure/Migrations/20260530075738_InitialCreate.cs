    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favourites", x => new { x.UserId, x.MediaItemId });
                    table.ForeignKey(
                        name: "FK_Favourites_MediaItems_MediaItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MediaShares_UserProfiles_SharedByUserId",
                        column: x => x.SharedByUserId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MediaShares_UserProfiles_SharedToUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favourites_MediaItemId",
                table: "Favourites",
                column: "MediaItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaShares_SharedByUserId",
                table: "MediaShares",
                column: "SharedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaShares_SharedToUserId",
                table: "MediaShares",
